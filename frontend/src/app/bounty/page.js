  ...
  <div className="flex items-center p-4 bg-white rounded-lg shadow">
    ...
    {reward && (
      <div className="text-right">
        <span className="text-green-600 font-semibold">{reward} USDC</span>
      </div>
    )}
    <button className="ml-4 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 transition-colors">
      Apply Now
    </button>
  </div>
);
...
export default function BountyPage() {
  ...
  const bounties = [
    {
      logo: "https://pbs.twimg.com/profile_images/1825605053744635904/dyLTxyDW_400x400.jpg",
      title: "Improve Superteam Website",
      organization: "Henray",
      type: "Project",
      deadline: "Due in 1d",
      applicants: 7,
    ...
    {
      logo: "https://pbs.twimg.com/profile_images/1825605053744635904/dyLTxyDW_400x400.jpg",
      title: "Organize Superteam Meetup",
      organization: "Henry",
      type: "Project",
    ...
    {
      logo: "https://pbs.twimg.com/profile_images/1825605053744635904/dyLTxyDW_400x400.jpg",
      title: "Design Superteam Meetup Poster",
      organization: "Henri",
      type: "Bounty",
      deadline: "Due in 6d",
      applicants: 7,
    ...
    {
      logo: "https://pbs.twimg.com/profile_images/1825605053744635904/dyLTxyDW_400x400.jpg",
      title: "Organize Solana Breakpoint Malaysia",
      organization: "Henrie",
      type: "Project",
      ...
      <div className="max-w-4xl mx-auto p-4">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold flex items-center text-black">
            <span className="mr-2">💼</span> Superteam Malaysia Bounties
          </h1>
